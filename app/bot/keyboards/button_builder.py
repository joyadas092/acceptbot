...
def button_builder_keyboard(
    ...
    builder.row(
        InlineKeyboardButton(text="➕ Add Button", callback_data=f"btn:add:{chat_id}"),
    )

    builder.row(
        InlineKeyboardButton(text="👁 Preview", callback_data=f"btn:preview:{chat_id}"),
        InlineKeyboardButton(text="💾 Save", callback_data=f"btn:save:{chat_id}"),
    )

    builder.row(
        InlineKeyboardButton(text="← Back", callback_data=f"settings:welcome:{chat_id}"),
    )
...
def button_row_selector_keyboard(
    ...
    builder.adjust(2)
    builder.row(
        InlineKeyboardButton(text="❌ Cancel", callback_data=f"settings:buttons:{chat_id}"),
    )
